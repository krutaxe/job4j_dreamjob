...
class CandidateDbStoreTest {
    ...
    public void whenCreateCandidateCreate() {
        ...
        Candidate candidate = new Candidate(0, "Dima", "Java dev", LocalDate.now(), null);
        store.add(candidate);
    ...
    public void whenCreateCandidateName() {
        CandidateDbStore store = new CandidateDbStore(new Main().loadPool());
        Candidate candidate1 = new Candidate(0, "Dima", "Java dev", LocalDate.now(), null);
        Candidate candidate2 = new Candidate(0, "Roma", "PHP dev", LocalDate.now(), null);
    ...
    public void whenUpdateCandidateName() {
        CandidateDbStore store = new CandidateDbStore(new Main().loadPool());
        Candidate candidate1 = new Candidate(1, "Dima", "Java dev", LocalDate.now(), null);
        Candidate candidate2 = new Candidate(2, "Roma", "PHP dev", LocalDate.now(), null);
        store.add(candidate1);
        store.add(candidate2);
